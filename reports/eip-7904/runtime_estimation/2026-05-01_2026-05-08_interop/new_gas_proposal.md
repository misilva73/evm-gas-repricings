...
`./reports/eip-7904/2026-05-01_2026-05-08/runtime_estimation_autogenerated_report.md`.
...
|BLAKE2F|constant|0|37|inf|
|BLAKE2F|num_rounds|1|2|1.0|
|BLS12_G1ADD|constant|375|81|-0.78|
|BLS12_G2ADD|constant|600|114|-0.81|
|DIV|constant|5|5|0.0|
|ECADD|constant|150|103|-0.31|
|ECPAIRING|constant|45000|9371|-0.79|
|ECPAIRING|num_pairs|34000|10196|-0.7|
|ECRECOVER|constant|3000|4107|0.37|
|KECCAK256|constant|30|38|0.27|
|KECCAK256|msg_size|6|1|-0.83|
|MOD|constant|5|6|0.2|
|MULMOD|constant|8|12|0.5|
|P256VERIFY|constant|6900|7238|0.05|
|POINT_EVALUATION|constant|50000|86605|0.73|
...
| :---: | :---: | :---: | :---: | :---: | :---: |
|ADDMOD|constant|besu|0.0000|0.0000|2|
...
|BLAKE2F|constant|geth|0.0000|0.0012|0|
|BLAKE2F|constant|nethermind|0.0000|0.0015|0|
|BLAKE2F|constant|reth|0.0004|0.0001|37|
...
|BLS12_G1ADD|constant|besu|0.0004|0.0017|36|
|BLS12_G1ADD|constant|erigon|0.0004|0.0014|39|
|BLS12_G1ADD|constant|geth|0.0000|0.0012|0|
|BLS12_G1ADD|constant|nethermind|0.0000|0.0015|0|
|BLS12_G1ADD|constant|reth|0.0008|0.0001|81|
|BLS12_G2ADD|constant|besu|0.0007|0.0017|70|
|BLS12_G2ADD|constant|erigon|0.0008|0.0014|82|
|BLS12_G2ADD|constant|geth|0.0001|0.0012|13|
|BLS12_G2ADD|constant|nethermind|0.0000|0.0015|3|
...
|ECADD|constant|geth|0.0000|0.0012|0|
|ECADD|constant|nethermind|0.0000|0.0015|0|
|ECADD|constant|reth|0.0010|0.0001|103|
|ECPAIRING|constant|besu|0.0434|0.0018|4341|
|ECPAIRING|constant|erigon|0.0612|0.0014|6119|
|ECPAIRING|constant|geth|0.0442|0.0012|4419|
|ECPAIRING|constant|nethermind|0.0491|0.0015|4909|
|ECPAIRING|constant|reth|0.0937|0.0001|9371|
...
|ECRECOVER|constant|besu|0.0057|0.0017|570|
|ECRECOVER|constant|erigon|0.0411|0.0013|4107|
|ECRECOVER|constant|geth|0.0066|0.0012|659|
|ECRECOVER|constant|nethermind|0.0050|0.0015|504|
...
|P256VERIFY|constant|besu|0.0073|0.0017|727|
|P256VERIFY|constant|erigon|0.0724|0.0013|7238|
|P256VERIFY|constant|geth|0.0105|0.0012|1046|
|P256VERIFY|constant|nethermind|0.0067|0.0015|672|
|P256VERIFY|constant|reth|0.0096|0.0001|956|
|POINT_EVALUATION|constant|besu|0.2122|0.0018|21216|
|POINT_EVALUATION|constant|erigon|0.8660|0.0013|86605|
|POINT_EVALUATION|constant|geth|0.1895|0.0012|18953|
|POINT_EVALUATION|constant|nethermind|0.2033|0.0015|20333|
...
|SMOD|constant|nethermind|0.0000|0.0000|2|
...
- **DUP10** (clients: nethermind) — affects: ADDMOD, MULMOD, SMOD

- **DUP11** (clients: nethermind) — affects: ADDMOD, MOD, MULMOD, SMOD

- **DUP12** (clients: nethermind) — affects: ADDMOD, MOD, MULMOD, SMOD

- **DUP14** (clients: nethermind) — affects: ADDMOD, MOD, MULMOD, SMOD

- **DUP2** (clients: nethermind) — affects: ADDMOD, DIV, MOD, MULMOD, SDIV, SMOD

- **DUP3** (clients: nethermind) — affects: ADDMOD, MOD, MULMOD, SMOD

- **DUP4** (clients: nethermind) — affects: ADDMOD, MULMOD

- **DUP5** (clients: nethermind) — affects: ADDMOD, MOD, MULMOD, SMOD

- **DUP7** (clients: nethermind) — affects: ADDMOD, MULMOD

- **DUP9** (clients: nethermind) — affects: ADDMOD, MOD, MULMOD, SMOD

- **MLOAD** (clients: besu, erigon, geth, nethermind, reth) — affects: ECPAIRING, ECRECOVER, P256VERIFY, POINT_EVALUATION

- **POP** (clients: erigon, geth, nethermind) — affects: ADDMOD, BLAKE2F, BLS12_G1ADD, BLS12_G2ADD, ECADD, ECPAIRING, MOD, MULMOD, P256VERIFY, POINT_EVALUATION, SMOD

- **PUSH0** (clients: geth) — affects: KECCAK256
